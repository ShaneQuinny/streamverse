...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">streamverse-fe documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Audit.html" data-type="entity-link" >Audit</a>
                            </li>
                            <li class="link">
                                <a href="components/AuditRecord.html" data-type="entity-link" >AuditRecord</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TitleDataGrid.html" data-type="entity-link" >TitleDataGrid</a>
                            </li>
                            <li class="link">
                                <a href="components/Titles.html" data-type="entity-link" >Titles</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/ExternalService.html" data-type="entity-link" >ExternalService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/GenreCount.html" data-type="entity-link" >GenreCount</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/TopReviewedTitle.html" data-type="entity-link" >TopReviewedTitle</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
